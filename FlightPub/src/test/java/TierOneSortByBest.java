...
public class TierOneSortByBest {
    ...
    public void parisToMadrid270918() {
        ...
        driver.findElement(By.id("departuredate")).sendKeys("27/09/2018");
        driver.findElement(By.cssSelector(".container:nth-child(2) > .row:nth-child(1)")).click();
        try {
            Thread.sleep(5000);
        ...
        WebElement ratingSliderAfter = driver.findElement(By.name("ratingWeight"));
        for (int i = 1; i <= 4 ; i++) {
            ratingSliderAfter.sendKeys(Keys.ARROW_RIGHT);
        }
    ...
    @Test
    public void parisToMadrid271018() {
        ...
        driver.findElement(By.id("departuredate")).click();
        driver.findElement(By.id("departuredate")).clear();
        driver.findElement(By.id("departuredate")).sendKeys("27/10/2018");
        driver.findElement(By.cssSelector(".container:nth-child(2) > .row:nth-child(1)")).click();
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
