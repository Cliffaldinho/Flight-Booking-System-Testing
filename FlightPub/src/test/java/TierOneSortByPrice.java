...
import java.util.*;
public class TierOneSortByPrice {
    ...
    public void parisToMadrid270918() {
        //Search for Paris to Madrid 27/09/2018 One Way
        ...
        WebElement priceSliderAfter = driver.findElement(By.name("priceWeight"));
        for (int i = 1; i <= 4 ; i++) {
            priceSliderAfter.sendKeys(Keys.ARROW_RIGHT);
        }
    ...
    public void cairnsToHobart270218() {
        //Search for Cairns to Hobart 27/02/2018 One Way
        driver.get("http://localhost:8080/");
        driver.manage().window().setSize(new Dimension(1536, 824));
        driver.findElement(By.cssSelector("form:nth-child(1)")).click();
        driver.findElement(By.id("departure")).clear();
    ...
    public void laToNY220917() {
        //Search for Los Angeles to New York 22/09/2017 One Way
        driver.get("http://localhost:8080/");
        driver.manage().window().setSize(new Dimension(1536, 824));
        driver.findElement(By.cssSelector("form:nth-child(1)")).click();
        driver.findElement(By.id("departure")).clear();
